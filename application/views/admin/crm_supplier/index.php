<h5 class="font-20 mt-15 mb-1"><?php echo str_replace('_',' ','Crm_supplier'); ?></h5>
<?php
...
<div>
	<div class="float_left padding_10">
		<a href="<?php echo site_url('admin/crm_supplier/save'); ?>"
			class="btn btn-success">Add</a>
	</div>
	<div class="float_left padding_10">
		<i class="fa fa-download"></i> Export <select name="xeport_type"
			class="select"
			onChange="window.location='<?php echo site_url('admin/crm_supplier/export'); ?>/'+this.value">
	...
	<div class="float_right padding_10">
		<ul class="left-side-navbar d-flex align-items-center">
			<li class="hide-phone app-search mr-15">
                <?php echo form_open_multipart('admin/crm_supplier/search/',array("class"=>"form-horizontal")); ?>
...
<table class="table table-striped table-bordered">
    ...
    <tr>
		...
		<td><?php echo $c['license_number']; ?></td>
		<td><?php
    ...
    ?>
		...
		<td><a
			href="<?php echo site_url('admin/crm_supplier/details/'.$c['id']); ?>"
			class="action-icon"> <i class="zmdi zmdi-eye"></i></a> <a
			href="<?php echo site_url('admin/crm_supplier/save/'.$c['id']); ?>"
			class="action-icon"> <i class="zmdi zmdi-edit"></i></a> <a
			href="<?php echo site_url('admin/crm_supplier/remove/'.$c['id']); ?>"
			onClick="return confirm('Are you sure to delete this item?');"
			class="action-icon"> <i class="zmdi zmdi-delete"></i></a></td>
	</tr>
	<?php } ?>
</table>
<!--End of Data display of crm_supplier//-->

<!--No data-->
<?php
if (count($crm_supplier) == 0) {
    ?>
<div align="center">
